...
- Дополнительно к `docs/` можно вести Wiki-страницы проекта: `https://github.com/maxbaydi/yasniy/wiki`
- Рекомендуется синхронизировать основные страницы Wiki с материалами из `docs/*.md`.
