...
## 10. Практический пример: факториал
...
## 13. Fullstack пример (backend + HTML)

Готовый пример лежит в `examples/`:

- backend: `examples/backend/main.яс`
- модули backend: `examples/backend/lib/*.яс`
- frontend: `examples/frontend/index.html`
- конфиг запуска: `examples/yasn.toml`
